...
data_root = 'datasets/Italy_dataset'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='HRFDataset',
            data_root='datasets/Italy_dataset',
            img_dir='train_data_png_size_256',
            ann_dir='train_label_png_size_256',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations'),
                dict(
    ...
    val=dict(
        type='HRFDataset',
        data_root='datasets/Italy_dataset',
        img_dir='test_data_png_size_256',
        ann_dir='test_label_png_size_256',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
